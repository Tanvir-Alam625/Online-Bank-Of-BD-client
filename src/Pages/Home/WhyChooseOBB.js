  ...
  return (
    <div className="bg-base-200 pb-5">
      <div className="pt-8 pb-5 relative ">
        <h1 className="section-title text-2xl font-bold mt-5">
          Why Choose{" "}
          <span className="text-green-700 font-serif font-bold">
            Online Bank BD
          </span>
        </h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mx-10 mt-5 ">
        <div className="card w-96  bg-base-200 hover:bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center text-center">
            ...
            <p>
              We provide fastest service to customers. Our aim is to provide
              fast service.
            </p>
            <div className="card-actions">
              <button className="text-1xl px-4 py-1 text-white bg-green-700 rounded-full ">
                See More
              </button>
            </div>
          </div>
        ...
        <div className="card w-96 bg-base-200 hover:bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center text-center">
            ...
            <p>
              Our bank provides maximum security to customers. Our job is to
              provide security for your money.
            </p>
            <div className="card-actions">
              <button className="text-1xl px-4 py-1 text-white bg-green-700 rounded-full ">
                See More
